...
/**
 * Store class implements the Singleton pattern, providing
 * a centralized storage and state management solution.
...
export default class Store {
	...
	constructor(initialState) {
		...
		const saveUser = this.storageService.getItem(USER_STORAGE_KEY)

		const state = saveUser ? { user: saveUser } : initialState
