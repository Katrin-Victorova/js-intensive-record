/**
 * StorageService is a class that  provides an interface for working
 * with localStorage  in a more convenient and structured way.
 */
export class StorageService {
	/**
	 * Retrieves an item from localStorage by the provided key.
	 * @param {string} key - The key of the item to be retrieved.
	 * @param {any} - The value of the item, or null if the item doesn't exist.
	 */
	getItem(key) {
